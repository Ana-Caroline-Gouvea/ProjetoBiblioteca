...
namespace ProjetoBiblioteca.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PessoaId,PessoaNome,PessoaRM")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PessoaId,PessoaNome,PessoaRM")] Pessoa pessoa)
        {
